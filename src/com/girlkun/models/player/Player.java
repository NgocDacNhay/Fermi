        ...
        if (!this.beforeDispose) {
            try {
                if (!iDMark.isBan()) {
                    ...
                    if (this.nPoint.power > 200 && this.nPoint.power < 400000000000L) {
...
//                        ChangeMapService.gI().changeMapBySpaceShip(this, 149, -1, 163);
    ...
    public short getHead() {
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            return (short) 1444;
        }  if (effectSkill != null && effectSkill.isBroly) {
            return (short) 1437;
...
//        PVPServcice.gI().finishPVP(this, PVP.TYPE_DIE);
    ...
    public void banv(Player player) {
        try {
            if (this.banv && player.inventory.gold <= Inventory.LIMIT_GOLD && player != null) {
                Item tv = null;
                ...
                if (tv != null) {
                    if (player.inventory.gold <= Inventory.LIMIT_GOLD) {
                        ...
                        Service.getInstance().sendThongBao(player, "không được vượt quá 1000 tỷ vàng");
                    }
                } else {
