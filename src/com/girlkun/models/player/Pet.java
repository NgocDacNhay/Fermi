 ...
 public void fusion(boolean porata) {
    ...
    public void update() {
        try {
            ...
            if (isDie()) {
                if (System.currentTimeMillis() - lastTimeDie > 20000) {
                ...
                case PROTECT:
                        ...
                        if (disToMob <= ARANGE_ATT_SKILL1) {
                            ...
                            if (SkillService.gI().canUseSkillWithCooldown(this)) {
                                if (SkillService.gI().canUseSkillWithMana(this)) {
                                    PlayerService.gI().playerMove(this, playerAttack.location.x + Util.nextInt(-15, 15), playerAttack.location.y);
                                    SkillService.gI().useSkill(this, playerAttack, null,null);
                                } else {
                                    askPea();
                                    UseItem.eatPea(this.master);
                                }
                            }
                        } else {
                            //chưởng
                    ...
                    if (mobAttack != null) {
                        ...
                        if (disToMob <= ARANGE_ATT_SKILL1) {
                            ...
                            if (SkillService.gI().canUseSkillWithCooldown(this)) {
                                if (SkillService.gI().canUseSkillWithMana(this)) {
                                    PlayerService.gI().playerMove(this, mobAttack.location.x + Util.nextInt(-10, 10), mobAttack.location.y);
   ...
   private void increasePoint() {
        if (this.nPoint != null && Util.canDoWithTime(lastTimeIncreasePoint, 1)) {
            if (Util.isTrue(5, 100)) {
                this.nPoint.increasePointForPet((byte) 2, (short) 1);
            } else {
                byte type = (byte) Util.nextInt(0, 2);
                short point = (short) Util.nextInt(10);
                this.nPoint.increasePointForPet(type, point);
            }
