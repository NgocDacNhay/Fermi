...
import com.arriety.models.map.RanDoc.ConDuongRanDocService;
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Danh hiệu","Giải tán bang hội", "Lãnh địa Bang Hội", "Kho báu dưới biển","Chuyển sinh");
                    }
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Chào mừng con đã đền với sever này sau đây ta có phần quà muốn tặng con\n"
                                        + "Con đang có những phần quá hấp dẫn hãy bấm vào những ô dưới để nhận"
                                .replaceAll("%1", player.gender == ConstPlayer.TRAI_DAT ? "Quy lão Kamê"
                                        : player.gender == ConstPlayer.NAMEC ? "Trưởng lão Guru" : "Vua Vegeta"),
                                "Nhận ngọc\nxanh", "Nhận đệ tử", "Nhập giftcode");
                    }
                }
            }
...
//                                break;
//                            case 2:
//                                NpcService.gI().createTutorial(player, this.avartar, ConstNpc.HUONG_DAN_NHAN_VANG_NGOC);
//                                break;
                            case 0:
                            ...
                            case 20:
                                if (player.inventory.ruby == 200000) {
                                    this.npcChat(player, "Bạn phải sài hết 200k ngọc xanh mowia được nhận tiếp");
                                    break;
                                }
...
//                                break;
                            case 2:
                                ...
                                break;
                            case 3: {
                                if (player.playerTask.taskMain.id == 1) {
                                    if (player.playerTask.taskMain.index == 0) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_1_0);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
                                } else if (player.playerTask.taskMain.id == 2) {
                                    if (player.playerTask.taskMain.index == 0) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_2_0);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
                                } else if (player.playerTask.taskMain.id == 3) {
                                    if (player.playerTask.taskMain.index == 0) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_3_0);
                                    } else if (player.playerTask.taskMain.index == 1) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_3_1);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
                                } else if (player.playerTask.taskMain.id == 4) {
                                    if (player.playerTask.taskMain.index == 0) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_4_0);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
                                } else if (player.playerTask.taskMain.id == 5) {
                                    if (player.playerTask.taskMain.index == 0) {
                                ...
                                } else if (player.playerTask.taskMain.id == 7) {
                                    if (player.playerTask.taskMain.index == 0) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_7_0);
                                    } else if (player.playerTask.taskMain.index == 1) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_7_1);
                                    } else if (player.playerTask.taskMain.index == 2) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_7_2);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
                                } else if (player.playerTask.taskMain.id == 10) {
                                    if (player.playerTask.taskMain.index == 0) {
                                    ...
                                    } else if (player.playerTask.taskMain.id == 1) {
                                    if (player.playerTask.taskMain.index == 0) {
                                        for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                            TaskService.gI().doneTask(player, ConstTask.TASK_18_0);
                                        }
                                    } else if (player.playerTask.taskMain.index == 1) {
                                        for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                        ...
                                        for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                            TaskService.gI().doneTask(player, ConstTask.TASK_18_2);
                                        }
                                    } else if (player.playerTask.taskMain.index == 3) {
                                        for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                            TaskService.gI().doneTask(player, ConstTask.TASK_18_3);
                                        }
                                    } else if (player.playerTask.taskMain.index == 4) {
                                        for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                            TaskService.gI().doneTask(player, ConstTask.TASK_18_4);
                                        }
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
    ...
    public static Npc toriBot(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player pl) {
                if (canOpenNpc(pl)) {
                    ShopServiceNew.gI().opendShop(pl, "TORI", false);
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 2:
                                   ...
                                   "Số coin của bạn đang có là: " + player.getSession().coinBar + " coin\n"
                                   + "Bạn Muốn Quy Đổi Thỏi Vàng Hay Ngọc Hãy Chọn Vàng Hoặc Ngọc",
                                     "Quy đổi\nThỏi vàng", "Quy đổi\nHồng ngọc", "không");
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_THOI_VANG, "Chọn các mệnh giá muốn quy đổi thỏi vàng\nTỉ lệ quy đổi là 1:1 ví dụ: \nnếu hạn chọn mệnh giá là 10k thì sẽ nhận được 10k thỏi vàng", 
                                            "Mệnh giá\n10k", "Mệnh giá\n20k", "Mệnh giá\n30k", "Mệnh giá\n50K", "Mệnh giá\n100k", "Mệnh giá\n200k", "Mệnh giá\n300k", "Mệnh giá\n500k", "Mệnh giá\n1 triệu");
                                    break;
 //                                   Input.gI().createFormQDTV(player);
                                case 1:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_HN, "Chọn các mệnh giá muốn quy đổi hồng ngọc\nTỉ lệ quy đổi là 1:1 ví dụ: \nnếu hạn chọn mệnh giá là 10k thì sẽ nhận được 10k hồng ngọc", 
                                            "Mệnh giá\n10k", "Mệnh giá\n20k", "Mệnh giá\n30k", "Mệnh giá\n50K", "Mệnh giá\n100k", "Mệnh giá\n200k", "Mệnh giá\n300k", "Mệnh giá\n500k", "Mệnh giá\n1 triệu");
                                    break;
                            }
                    ...
                    break;
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (player.getSession().coinBar >= coin) {
                                PlayerDAO.subcoinBar(player, coin);
                        Item thoiVang = ItemService.gI().createNewItem((short) 861, tv);// x3
                        Item dns = ItemService.gI().createNewItem((short) 674, dans);// x3
                        InventoryServiceNew.gI().addItemBag(player, thoiVang);
                        InventoryServiceNew.gI().addItemBag(player, dns);
                        InventoryServiceNew.gI().sendItemBags(player);
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (player.rubyWin > 0) {
                        createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Chẵn lẻ đê.\n Bạn đã thắng được " + Util.numberToMoney((int) (player.rubyWin * 1.5))
                                        + " thỏi vàng\n",
                            ...
                            switch (select) {
                                ...
                                case 0:
                                    if (!PariryServices.gI().checkHavePariry()) {
                                        Service.getInstance().sendThongBaoOK(player, "Chưa có phiên chẵn lẻ nào khởi động");
                                        break;
                                    }
    ...
    public static Npc nguoiBiAn(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 104) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Xin chào, tôi có thể giúp gì cho cậu?","Cửa hàng\nĐá quý","Tới hành tinh\nBroly", "Từ chối");
                    } else if (this.mapId == 146) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Xin chào, tôi có thể giúp gì cho cậu?","Cửa hàng\nĐá quý", "Quay về", "Từ chối");
                    } else {
                        super.openBaseMenu(player);
                    }
                }
                ...
                if (canOpenNpc(player)) {
                    switch (player.iDMark.getIndexMenu()) {
                        case ConstNpc.BASE_MENU:
                            if (this.mapId == 104) {
                                if (select == 0) {
                                    ShopServiceNew.gI().opendShop(player, "DA_QUY", false);
                                }
                                if (select == 1) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 146, -1, 456);
                                }
                            }
                            if (this.mapId == 146) {
                                if (select == 0) {
                                ...
                                if (select == 1) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 104, -1, 456);
                                }
                            }
                            break;
                    }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                createOtherMenu(player, ConstNpc.EP_SAO,
                                        "Ngươi tìm ta có việc gì?\n",
                                        "Ép sao\ntrang bị", "Ép sao\ncải trang","Từ Chối");
                                break;
                                case 1:
                                createOtherMenu(player, ConstNpc.PHA_LE_HOA,
                                            "Ngươi tìm ta có việc gì?\n",
                                            "Pha lê\nhoá\ntrang bị","Pha lê\nhoá\ntrang bị\n100 lần","Pha lê\nhoá\ncải trang","Từ Chối");
                                    break;
                                case 2:
...
//                                    break;
                            ...
                            switch (player.combineNew.typeCombine) {
                                ...
                                case CombineServiceNew.EP_SAO_CAI_TRANG:
...
//                                case CombineServiceNew.NANG_CAP_SKH_VIP:
                        ...
                        else if (player.iDMark.getIndexMenu() == ConstNpc.EP_SAO) {
                            switch (select) {
                                case 0:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.EP_SAO_TRANG_BI );
                                    break;
                                case 1:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.EP_SAO_CAI_TRANG);
                                    break;
                                
                            }
                        }
                        else if (player.iDMark.getIndexMenu() == ConstNpc.PHA_LE_HOA) {
                            switch (select) {
                                case 0:
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.PLH_CAITRANG );
                                    break;
                ...
                if (canOpenNpc(player)) {
                    if (mapId == 0) {
                        ...
                        if (now > nguhs.TIME_OPEN_NHS && now < nguhs.TIME_CLOSE_NHS) {
                            this.createOtherMenu(player, 0, "Ngũ Hàng Sơn x10 Tnsm\nHỗ trợ cho Ae trên 80 Tỷ SM?\n Hỗ trợ anh em full time, 250 hồng ngọc 1 lần vào", "Éo", "OK");
                        } else {
                            this.createOtherMenu(player, 0, "Ngũ Hàng Sơn x10 Tnsm\nHỗ trợ cho Ae trên 80 Tỷ SM?\nHỗ trợ anh em full time, 250 hồng ngọc 1 lần vào", "Éo");
                        }
                    }
                    if (mapId == 123) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 48) {
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            switch (select) {
                                case 0:
                                    if (player.isAdmin() && player.clanMember.getNumDateFromJoinTimeToToday() >= 2 || player.nPoint.power >= ConDuongRanDoc.POWER_CAN_GO_TO_CDRD && player.clanMember.getNumDateFromJoinTimeToToday() >= 2) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                            case 0:
                              ShopServiceNew.gI().opendShop(player, "NGU_SAC", true);
                              break;
                            case 1:
                            Input.gI().createFormQDHRZ(player);
                             break;
                            case 2:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.DOI_DT_1, 9075,
                                        "|7|Số tiền của bạn là : " + player.getSession().coinBar + "k vnd\n"
                                                
                                                + "|8|Tùy chọn 1: Đệ Uub(HP-MP + 10%), (DMG + 10%)\n"
                                                + "Tùy chọn 2: Đệ Pic (HP-MP + 15%), (DMG + 15%)\n"
                                                + "Tùy chọn 3: Đệ Goku vô cực (HP-MP + 17%), (DMG + 17%)\n"
                                                + "Tùy chọn 4: Đệ Cumber (HP-MP + 20%), (DMG + 20%)\n"
                                                + "Tùy chọn 5: Đệ Cumber Gold (HP-MP + 10%), (DMG + 10%)\n"
                                                + "Tùy chọn 6: Đệ Bill Bí Ngô (HP-MP + 15%), (DMG + 15%)\n"
                                                + "Tùy chọn 7: Đệ Chill Chưa Tiền Hoá (HP-MP + 17%), (DMG + 17%)\n"
                                                + "Tùy chọn 8: Đệ Chill Đã Tiền Hoá (HP-MP + 20%), (DMG + 20%)\n"
                                                + "|7| Chỉ Tính DMG-HP-MP khi hợp thể nó sẽ tăng phần trăm khi mua đệ ở cửa hàng, Hợp thể bằng bông tai cấp 4 có thể tăng lên 3%\n",
                                         "Đệ uub\n30k", "Đệ pic\n50k","Đệ goku\n70k","Đệ cumber\n90k",
                                         "Đệ Cumber Gold\n99k","Đệ Bill\n110k","Đệ Chill V1\n120k","Đệ Chill V2\n130k","Từ Chối");
                                break;
                                case 3:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.DOI_DT_2, 9075,
                                        "|7|Số tiền của bạn là : " + player.getSession().coinBar + "k vnd\n"
                                                + "|2|Tùy chọn 1: Đệ Tanjiro (HP-MP + 22%), (DMG + 22%)\n"
                                                + "Tùy chọn 2: Đệ Hashibira (HP-MP + 25%), (DMG + 25%)\n"
                                                + "Tùy chọn 3: Đệ Inosuke (HP-MP + 30%), (DMG + 30%)\n"
                                                + "Tùy chọn 4: Đệ Zenitsu (HP-MP + 35%), (DMG + 35%)\n"
                                                + "Tùy chọn 5: Đệ Nezuko (HP-MP + 39%), (DMG + 39%)\n"
                                                + "Tùy chọn 6: Đệ Cumber 4.0 (HP-MP + 43%), (DMG + 43%)\n"
                                                + "Tùy chọn 7: Đệ Cumber Super 4.0 (HP-MP + 47%), (DMG + 47%)\n"
                                                + "|7| Chỉ Tính DMG-HP-MP khi hợp thể nó sẽ tăng phần trăm khi mua đệ ở cửa hàng, Hợp thể bằng bông tai cấp 4 có thể tăng lên 3%\n",
                                         "Đệ Tanjiro\n30k", "Đệ Hashibira\n50k","Đệ Inosuke\n70k","Đệ Zenitsu\n90k",
                                         "Đệ Nezuko\n99k","Đệ Cumber 4.0\n90k","Đệ Cumber Super 4.0\n99k","Từ Chối");
                                break;
                                case 4:
    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            switch (tempId) {
                ...
                case ConstNpc.NGUOI_BI_AN:
                    return nguoiBiAn(mapId, status, cx, cy, tempId, avatar);
...
//                        }
                    ...
                    case ConstNpc.BUFF_PET:
                        ...
                        break;
                    case ConstNpc.DOI_DT_1:  // dang sua
                        switch (select) {
                            case 0:
                            ...
                            case 2:  //
                             ...
                             case 3:  //
                               ...
                               if (player.getSession().coinBar >= 200000) {
                                  ...
                                  try {
                                        ...
                                        PlayerDAO.subcoinBar(player, 200000);
                                         PetService.gI().changeCumberGoldPet(player, player.gender);
                               ...
                               if (player.getSession().coinBar >= 200000) {
                                  ...
                                  try {
                                        PlayerDAO.subcoinBar(player, 200000);
                                         PetService.gI().changeBillBiNgoPet(player, player.gender);
                                       // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 200000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                               ...
                               if (player.getSession().coinBar >= 200000) {
                                  ...
                                  try {
                                        ...
                                        PlayerDAO.subcoinBar(player, 200000);
                                         PetService.gI().changeChillConPet(player, player.gender);
                                       // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 200000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                               ...
                               if (player.getSession().coinBar >= 200000) {
                                  ...
                                  try {
                                        PlayerDAO.subcoinBar(player, 200000);
                                         PetService.gI().changeChillBoPet(player, player.gender);
                                       // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 200000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        switch (select) {
                            case 0:
                                if (player.getSession().coinBar >= 30000) {
                                   ...
                                   try {
                                        PlayerDAO.subcoinBar(player, 30000);
                                         PetService.gI().changeTanjiroPet(player, player.gender);
                                    //    GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 300000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                             ...
                             case 1:
                                if (player.getSession().coinBar >= 50000) {
                                   ...
                                   try {
                                        PlayerDAO.subcoinBar(player, 50000);
                                         PetService.gI().changeHashibiraPet(player, player.gender);
                                    //    GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 300000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            case 2:
                               if (player.getSession().coinBar >= 100000) {
                                   ...
                                   try {
                                       PlayerDAO.subcoinBar(player, 100000);
                                         PetService.gI().changeInosukePet(player, player.gender);
                                       // GirlkunDB.executeUpdate("update player set coinruby = (coinruby - 100000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                             ...
                             case 3:
                               if (player.getSession().coinBar >= 150000) {
                                  ...
                                  try {
                                        ...
                                        PlayerDAO.subcoinBar(player, 150000);
                                         PetService.gI().changeZanitsuPet(player, player.gender);
                                    //    GirlkunDB.executeUpdate ("player set coinruby = (coinruby - 100000 where id =  + player.id");
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            case 4:  //
                               if (player.getSession().coinBar >= 200000) {
                                  ...
                                  try {
                                        ...
                                        PlayerDAO.subcoinBar(player, 200000);
                                         PetService.gI().changeNezukoPet(player, player.gender);
                                       // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 200000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            case 5:
                               if (player.getSession().coinBar >= 150000) {
                                  ...
                                  try {
                                        PlayerDAO.subcoinBar(player, 150000);
                                         PetService.gI().changeCumber4Pet(player, player.gender);
                                    //    GirlkunDB.executeUpdate ("player set coinruby = (coinruby - 100000 where id =  + player.id");
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            case 6:
                               if (player.getSession().coinBar >= 200000) {
                                  ...
                                  try {
                                        ...
                                        PlayerDAO.subcoinBar(player, 200000);
                                         PetService.gI().changeCumberSuper4Pet(player, player.gender);
                                       // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 200000) where id = " + player.id);
                                        Service.getInstance().sendThongBao(player, "doi thanh cong");
                                    } catch (Exception ex) {
                                        java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            case 1:
                                if (player.pet == null) {
                                    ...
                                    if (player.pet.typePet == 1) {
                                        PetService.gI().changeBillPet(player);
