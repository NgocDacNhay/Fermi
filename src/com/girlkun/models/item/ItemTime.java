...
public class ItemTime {
    ...
    public static final int TIME_MAY_DO3 = 3600000;
    ...
    public void update() {
        ...
        if (isUseMayDo3) {
            if (Util.canDoWithTime(lastTimeUseMayDo2, TIME_MAY_DO3)) {
                isUseMayDo3 = false;
            }
        }
        if (isUseMaydoDaPs) {
            if (Util.canDoWithTime(lastTimeMaydoDaPs, TIME_MAY_DO2)) {
                isUseMaydoDaPs = false;
            }
        }
        if (isUseBinhCanx2) {
