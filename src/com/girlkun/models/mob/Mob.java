...
//            }            if (Util.isTrue(1.0f, 100)) {
    ...
    public List<ItemMap> getItemMobReward(Player player, int x, int yEnd) {
        ...
        if (player.itemTime.isUseMaydoDaPs && Util.isTrue(21, 100) && this.tempId > 57 && this.tempId < 66) {
        ...
        if (Util.isTrue(10, 100)) {    //up bí kíp
            ...
            if (this.tempId>0 && this.zone.map.mapId>=0 && this.zone.map.mapId<=14){
                if (Util.isTrue(100, 100)) {    //up bí kíp
