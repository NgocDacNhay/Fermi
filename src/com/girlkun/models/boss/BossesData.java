...
//            new int[]{BossID.THAN_HUY_DIET_CHAMPA}
    ...
    public static final BossData YADART_CLONE = new BossData(
     ...
     public static final BossData YADART = new BossData(
            ...
            new String[]{"|-1|Gaaaaaaaa!!!"},
             REST_1_M, //s
             new int[]{BossID.YADART_CLONE}//type appear
    );
    ...
    public static final BossData BOSS_BROLY_THUONG = new BossData(
            "Broly", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1235, 1236, 1439, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000, //dame
            new int[]{1500000000}, //hp
    ...
    public static final BossData BOSS_BROLY_SUPER = new BossData(
            "Broly Super", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1437, 1438, 1439, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100000, //dame
            new int[]{2000000000}, //hp
            new int[]{146}, //map join
            new int[][]{
