...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
 ...
 public static final String queryTopSD = "SELECT id, \n"
            ...
            + "ORDER BY sd DESC\n"
            + "LIMIT 20;";
    public static final String queryTopHP = "SELECT id, CAST(SUBSTRING_INDEX(data_point, ',', -10) AS UNSIGNED) AS hp FROM player ORDER BY hp DESC LIMIT 100;";
    public static final String queryTopKI = "SELECT id, CAST(SUBSTRING_INDEX(data_point, ',', -9) AS UNSIGNED) AS ki FROM player ORDER BY ki DESC LIMIT 100;";
    public static final String queryTopNV = "SELECT id, CAST(SUBSTRING_INDEX(data_task, '[', -1) AS UNSIGNED) AS nv FROM player ORDER BY nv DESC LIMIT 50;";
