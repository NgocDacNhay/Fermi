...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_NHAN_VANG_NGOC = "Khi bạn đã nạp hãy qua ông mr satan\n"
            + "Bấm vào chữ quy đổi để nhận quy đổi thỏi vàng và hồng ngọc \n"
            + "Lưu ý nếu bạn nạp nhiều hãy liên hệ admin để nhận 1 danh hiệu top nạp \n"
            + "Nạp tối thiểu là 10k nếu nạp dưới 10k hãy liên hên admin để nạp \n"
            + "Khi bạn quy đổi thỏi vàng và hồng ngọc sẽ được tặng kèm đã ngũ sắc, nạp càng nhiều sẽ được càng nhiều đá ngũ sắc \n"
            + "Nếu quy lỗi bị lỗi hãy liên hệ admin để xử lý\n"
            + "Nếu bạn nạp khung giờ vàng sẽ được x2, x3, x4 số tiền nạp";
    ...
    public static final byte NGUOI_BI_AN= 77;
    ...
    public static final int DOI_DT_1  = 558;
     public static final int DOI_DT_2  = 559;
    
    public static final int PHAP_SU  = 560;
    public static final int EP_SAO  = 561;
    public static final int PHA_LE_HOA  = 562;
 ...
 public static final int TUTORIAL_SUMMON_DRAGONGOLDEN = 535;
      
     public static final int SUMMON_SHENRONGOLDEN = 536;
     
     public static final int SHENRONGOLDEN = 537;
    ...
    public static final int MENU_DOI_NHAN = 700;
    ...
    public static final int DANH_HIEU = 601;
}
