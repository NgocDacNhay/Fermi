                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            try {
                                ...
                                if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapConDuongRanDoc(mapId) || MapService.gI().isMapBlackBallWar(mapId)
                            ...
                            int maydoDaPs = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            ...
                            player.itemTime.lastTimeMaydoDaPs = System.currentTimeMillis() - (ItemTime.TIME_ITEM - maydoDaPs);
                            ...
                            player.itemTime.isUseMaydoDaPs = maydoDaPs !=0;
