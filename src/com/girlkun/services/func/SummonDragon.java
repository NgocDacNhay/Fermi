...
public class SummonDragon {
    ...
    public static final short GOLDEN_1SAO = 1240;
    public static final short GOLDEN_2SAO = 1241;
    public static final short GOLDEN_3SAO = 1242;
    public static final short GOLDEN_4SAO = 1243;
    public static final short GOLDEN_5SAO = 1244;
    public static final short GOLDEN_6SAO = 1245;
    public static final short GOLDEN_7SAO = 1246;
...
//                        }
                ...
                break;
                case 5:
                if(InventoryServiceNew.gI().getCountEmptyBag(this.playerSummonShenron) == 0) {
                    Service.getInstance().sendThongBao(playerSummonShenron, "Điều ước này chỉ dành cho tộc namec");
                    reOpenShenronWishes(playerSummonShenron);
                    return;
                }
                if (this.playerSummonShenron.gender != ConstPlayer.NAMEC) {
                    Service.getInstance().sendThongBao(playerSummonShenron, "Điều ước này chỉ dành cho tộc namec");
                    reOpenShenronWishes(playerSummonShenron);
                    return;
                } else {
                    Item sucManhTiemAn = ItemService.gI().createNewItem((short) 1347);
                    InventoryServiceNew.gI().addItemBag(playerSummonShenron, sucManhTiemAn);
                }
                break;
