            ...
            switch (item.template.type) {
                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 1102:
                        case 1103:
                        case 1232: //bình cần x2
                        case 1233: //bình cần x5
                        case 1234: //bình cần x7
                        case 1235: //bình cần x10
                        case 1239: //máy dò pháp sư
                        case 1347: //sushi
                            useItemTime(pl, item);
                            break;
                        case 521: //tdlt
                        ...
                        case 722: //đổi đệ tử
                            ...
                            break;
                        case 1335:
                            ItemService.gI().OpenItem1261(pl, item);
                            break;
                        case 1247:
                            ItemService.gI().OpenItem1247(pl, item);
                            break;
                            case 1258:
                            ItemService.gI().OpenItem1262(pl, item);
                            break;
                        case 1146: //đổi đệ tử
                            changePetBrl1(pl, item);
                            break;
                        case 1148: //đổi đệ tử
                            changeBrl(pl, item);
                            break;
...
//                                linhThu.itemOptions.add(new Item.ItemOption(96, Util.nextInt(5, 25)));
    ...
    int[] rdct = new int[]{1305};
    int randomct = new Random().nextInt(rdct.length);
    Item ct = ItemService.gI().createNewItem((short) rdct[randomct]);
        if (id <= 90){           
            ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(25, 55)));
            ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(25, 49)));
            ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(25, 49)));
            ct.itemOptions.add(new Item.ItemOption(101, Util.nextInt(200, 250))); 
            ct.itemOptions.add(new Item.ItemOption(93,Util.nextInt(3, 49)));            
        } else {                      
...
//    int[] rdop = new int[]{1246, 1247, 1248, 1249, 1250, 1251, 1252};
...
//    Item vt = ItemService.gI().createNewItem((short) rdop[randomop]);
//        if (id <= 50){           
//            ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 35)));
//            ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 30)));
//            ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 28)));
//            ct.itemOptions.add(new Item.ItemOption(93,Util.nextInt(3, 49)));            
//        }
//        else {
//            ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(1, 35)));
//            ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(1, 30)));
//            ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(1, 30)));         
//        }
//        if (id <= 99){           
...
//    }
   ...
   private void OpenhopThucuoi(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
    int id = Util.nextInt(0, 100);
    int[] rdpet = new int[]{1318,1319,1321,1322,1323,1324,1325};
    int[] rdop = new int[]{50, 77, 103};
    int randompet = new Random().nextInt(rdpet.length);
    int randomop = new Random().nextInt(rdop.length);
    Item pet = ItemService.gI().createNewItem((short) rdpet[randompet]);
        if (id <= 90){           
            pet.itemOptions.add(new Item.ItemOption(50,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(77,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(103,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(213,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(89,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(93,Util.nextInt(15, 30)));
        } else {                      
           pet.itemOptions.add(new Item.ItemOption(50,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(77,Util.nextInt(15, 30)));
            pet.itemOptions.add(new Item.ItemOption(103,Util.nextInt(15, 30)));
...
*/            
    ...
    private void changeBrl(Player player, Item item) {
        if (player.pet != null) {
            int gender = player.pet.gender;
            PetService.gI().changeBrl(player, gender);
            InventoryServiceNew.gI().subQuantityItemsBag(player, item, 1);
        } else {
            Service.gI().sendThongBao(player, "Không thể thực hiện");
        }
    ...
    private void changePetBrl1(Player player, Item item) {
        if (player.pet != null) {
            int gender = player.pet.gender;
            PetService.gI().changeBrl1Pet(player, gender);
            InventoryServiceNew.gI().subQuantityItemsBag(player, item, 1);
        } else {
            Service.gI().sendThongBao(player, "Không thể thực hiện");
        }
    ...
    private void OpenHopQuaNhapHoc(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            Item ct = ItemService.gI().createNewItem((short) Util.nextInt(1246, 1252));
            ct.itemOptions.add(new ItemOption(30, 30));
            if (item.template.id == 1244) {
                ct.itemOptions.add(new ItemOption(55, Util.nextInt(10, 35)));
                ct.itemOptions.add(new ItemOption(77, Util.nextInt(10, 30)));
                ct.itemOptions.add(new ItemOption(103, Util.nextInt(10, 30)));
                ct.itemOptions.add(new ItemOption(93, Util.nextInt(1, 50)));
            } else if (item.template.id == 1245) {
                ct.itemOptions.add(new ItemOption(93, Util.nextInt(7, 30)));
            }
            InventoryServiceNew.gI().addItemBag(pl, ct);
            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
    ...
    private void useItemTime(Player pl, Item item) {
        switch (item.template.id) {
            ...
            case 1235: //máy dò đồ
                ...
                break;
            case 1239: //máy dò đá pháp sư
                pl.itemTime.lastTimeMaydoDaPs = System.currentTimeMillis();
                pl.itemTime.isUseMaydoDaPs = true;
                break;
    ...
    private void useTDLT(Player pl, Item item) {
        if (pl.itemTime.isUseTDLT) {
            ...
            pl.itemTime.lastTimeUseTDLT = System.currentTimeMillis();
    ...
    public void usethoivang(Player player) {
        ...
        if (tv != null) {
            if (player.inventory.gold <= 10_000_000_000L) {
                ...
                Service.getInstance().sendThongBao(player, "không được vượt quá 10 tỷ vàng");
            }
        }
    }
